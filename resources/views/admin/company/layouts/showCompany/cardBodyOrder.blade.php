<div class="container-fluid">
    ...
    @if($order->status_data != null && $order->status_data != '')
        <? $array_cancel_data = json_decode($order->status_data);?>
        <div class="row bor-bottom pb-3 pt-3 bg-info">
            <div class="col-md-6">
                <p><span class="font-weight-bold">Причина отмены:</span> {{ $array_cancel_data->type }}</p>
            </div>
            <div class="col-md-6">
                <p><span class="font-weight-bold">Описание отмены:</span> {{ $array_cancel_data->text }}</p>
            </div>
        </div>
    @endif
</div>
