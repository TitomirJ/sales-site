...
@section('content')
    <div class="content-wrapper">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <h1 class="w-100 text-center">Опубликовать новость</h1>
                </div>
            </div>

            <form method="POST" action="{{ asset('/admin/blog/store') }}" enctype="multipart/form-data">
                {{ csrf_field() }}
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-group">
                            <textarea class="mytextarea  d-none" name="text"></textarea>
                        </div>
                    </div>
                </div>
                <div class="row mb-3">
                ...
                <button type="submit" class="btn square_btn shadow-custom text-uppercase border-radius-50 w-100">Создать новость</button>
            </form>
