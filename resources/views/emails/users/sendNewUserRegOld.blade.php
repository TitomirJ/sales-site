		...
		<tr>
			<td align="center" style="overflow: hidden;">
				<table width="600" cellpadding="0" cellspacing="0" border="0" style="border-collapse: collapse;overflow: hidden;">
					<tr>
						<td height="222" width="100%" style="background-image: url({{asset('/public/images/top.png')}}); margin-left: -5px;transform: scale(1.05);background-size: 104%;background-position: bottom;"></td>
					</tr>
				</table>
				<table width="600" cellpadding="0" cellspacing="0" border="0" style="border-collapse: collapse;background:#e9e9e9;margin-top:-12px">
					<tr>
						<td align="center" style="padding-top:30px;font-size:25px">Вы зарегистрировались на BigSales!</td>
					</tr>
					<tr align="center">
						<td height="2">
					...
					<tr>
						<td style="padding:27px 37px;font-size: 20px;text-transform: uppercase">
							<span>
								данные для входа:
							</span>
						</td>
					...
					<tr>
						<td style="font-size: 18px">
							Ваша почта: <span style="color:#000">{{$user->email}}</span>
						</td>
					</tr>
					<tr>
						<td style="padding: 10px 37px 30px;font-size: 18px">
					...
					<tr>
						<td style="padding: 27px 37px; color:#fff;">
							<div style="font-size:18px;font-weight: 600;padding-bottom: 10px">
								Телефоны:
								<a href="tel:067 666 54 66" style="font-weight: 300;color:#fff">067 666 54 66; </a>
								<a href="tel:066 666 54 86" style="font-weight: 300;color:#fff">066 666 54 86</a>
							</div>
							<div style="font-size:18px;font-weight: 600;">
								Электронная почта:
								<a href="mailto:support@peace-it.info" style="font-weight: 300;color:#fff">support@peace-it.info</a>
							</div>
						</td>
					</tr>
				</table>
