                        ...
                        <td>
                            <table width="540" align="center" cellspacing="0" cellpadding="0" border="0" class="devicewidthinner">
                                ...
                                <tr>
                                    <!-- start of image -->
                                    <td align="center">
                                        <a target="_blank" href="{{asset('/')}}"><img width="540" border="0" height="282" alt="" style="display:block; border:none; outline:none; text-decoration:none;" src="{{asset('/public/images/top-man.png')}}" class="bigimage"></a>
                                    </td>
                                </tr>
                                <!-- end of image -->
                                <!-- Spacing -->
