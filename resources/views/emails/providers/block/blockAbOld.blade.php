				...
				<table width="600" cellpadding="0" cellspacing="0" border="0" style="border-collapse: collapse;background:#e9e9e9;margin-top:-12px">
					<tr>
						<td align="center" style="padding-top:30px;font-size:20px">
							Ваша учетная запись заблокирована по причине отрицательного баланса абонплаты.
						</td>
					</tr>
					<tr align="center">
						<td height="2">
					...
					<tr>
						<td style="padding:27px 37px;font-size: 20px">
							<span>
								Вы можете произвести оплату в личном кабинете
							</span>
						</td>
					</tr>
					<tr align="center">
						<td style="padding: 10px 37px">
							<a href="https://bigsales.pro/check/company/balance" style="color:#fff;background:#7aa1e3;border-radius:15px;padding: 8px 15px;font-size: 18px">ОПЛАТИТЬ</a>
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td style="padding: 37px; color:#fff">
							<div style="padding-bottom: 10px;font-size:18px">
								Если вы уже совершили оплату проигнорируйте это сообщение
							</div>
						</td>
					</tr>
				</table>
				...
				<table width="600" cellpadding="0" cellspacing="0" border="0" style="border-collapse: collapse;background:#434a6b">
					<tr>
						<td style="padding: 27px 37px; color:#fff;">
							<div style="font-size:18px;font-weight: 600;padding-bottom: 10px">Телефоны: <a href="tel:067 666 54 66" style="font-weight: 300">067 666 54 66;<a href="tel:066 666 54 86" style="font-weight: 300">066 666 54 86</a></div>
							<div style="font-size:18px;font-weight: 600;">Электронная почта: <a href="mailto:support@peace-it.info" style="font-weight: 300">support@peace-it.info</a></div>
						</td>
					</tr>
				</table>
				<table width="600" cellpadding="0" cellspacing="0" border="0" style="border-collapse: collapse;background:#839ac3">
