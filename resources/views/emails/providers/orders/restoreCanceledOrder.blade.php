                        ...
                        <td>
                            <table width="540" align="center" cellspacing="0" cellpadding="0" border="0" class="devicewidthinner">
                                ...
                                <tr>
                                    <!-- start of image -->
                                    <td align="center">
                                        <a target="_blank" href="{{asset('/')}}"><img width="540" border="0" height="282" alt="" style="display:block; border:none; outline:none; text-decoration:none;" src="{{asset('/public/images/top-order.png')}}" class="bigimage"></a>
                                    </td>
                                </tr>
                                <!-- end of image -->
                                <!-- Spacing -->
                                ...
                                <tr>
                                    <td style="font-family: Helvetica, arial, sans-serif; font-size: 18px; color: #333333; text-align:center;line-height: 20px;" st-title="rightimage-title">
                                        Отмененный заказ № {{ $order->id }} востановлен!
                                    </td>
                                </tr>
                                <!-- end of title -->
                                <!-- Spacing -->
                                ...
                                <tr>
                                    <td style="font-family: Helvetica, arial, sans-serif; font-size: 14px; color: #000; text-align:center;line-height: 24px;" st-content="rightimage-paragraph">
                                        Заказ, который Вы не успели обработать в течении 24 часов был отменен, но теперь вы можете сменить его статус!
                                    </td>
                                </tr>
                                <!-- Spacing -->
                                <tr>
                            ...
                            <table width="540" align="center" cellpadding="0" cellspacing="0" border="0" class="devicewidthinner">
                                ...
                                <tr>
                                    <td style="font-family: Helvetica, arial, sans-serif; font-size: 18px; color: #fff; text-align:center;line-height: 20px;" st-title="fulltext-title">
                                        Для того,чтобы подвердить или отменить заказ, перейдите в личный кабинет
                                    </td>
                                </tr>
                                <!-- End of Title -->
                                <!-- Spacing -->
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <table height="36" align="center" valign="middle" border="0" cellpadding="0" cellspacing="0" class="tablet-button" st-button="edit">
                                            <tbody>
                                            <tr>
                                                <td width="auto" align="center" valign="middle" height="36" style=" border-top-left-radius:4px; border-bottom-left-radius:4px;border-top-right-radius:4px; border-bottom-right-radius:4px; background-clip: padding-box;font-size:13px; font-family:Helvetica, arial, sans-serif; text-align:center;  color:#ffffff; font-weight: 300; padding-left:25px; padding-right:25px;">
                                                   <span style="color: #ffffff; font-weight: 300;">
                                                      <a style="color: #ffffff; text-align:center;text-decoration: none;background:#7aa1e3;border-radius:15px;padding: 8px 15px;" href="https://bigsales.pro/company">Личный кабинет</a>
                                                   </span>
                                                </td>
                                            </tr>
                                            </tbody>
