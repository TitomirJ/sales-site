...
@endforelse
<tr>
    <td scope="col" colspan="9" class="text-center products-pagination" data-currentPage="{{ $products_chprice->currentPage() }}" data-type="2">{{ $products_chprice->links() }}</td>
</tr>