...
<td scope="col" class="text-center align-middle">
    <a href="{{ asset('admin/rozetka/chats/'.$chart->id) }}" target="_blank" title="Посмотеть переписку"><i class="fa fa-comments fa-2x text-warning" aria-hidden="true"></i></a>
    <a class="ml-3 get-link-to-com-modal" data-url="{{ asset('admin/rozetka/chats/'.$chart->id.'/edit') }}" title="Привязать к компании" style="cursor: pointer;"><i class="fa fa-link fa-2x text-info" aria-hidden="true"></i></a>
</td>