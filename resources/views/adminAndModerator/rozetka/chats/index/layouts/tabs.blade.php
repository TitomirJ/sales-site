...
<ul class="nav nav-pills flex-column flex-xl-row flex-nowrap nav-justified text-uppercase mb-3" >
    ...
    <li class="nav-item ml-5 mr-5 border-bot radius-top-left radius-top-right">
        <a class="nav-link rounded-0 dark-link <?= ($flag == 3) ? 'active' : '' ?> text-nowrap font-weight-bold" href="{{ asset('admin/rozetka/chats?type=other') }}">
    ...
    <li class="nav-item ml-5 mr-5 border-bot radius-top-left radius-top-right">
        <a class="nav-link rounded-0 dark-link <?= ($flag == 1) ? 'active' : '' ?> text-nowrap font-weight-bold"  href="{{ asset('admin/rozetka/chats?type=orders') }}">
            заказы
