        ...
        <div class="container-fluid mt-5">
            ...
            <div class="row mt-3" id="chart-block">
                <div class="col-12">
                    ...
                    @include('provider.company.message.index.layouts.tabs')

                    <div class="tab-content table-responsive scroll_wrap" >
                        <form action="{{ asset('company/actions/messages') }}" method="post" id="group-charts-actions">
                            {{ csrf_field() }}
                        ...
                        <table  class="table position-relative scroll_me">
                            <thead>
                                            ...
                                            <div class="input-group w-75">
                                                ...
                                                <div class="input-group-prepend">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        ...
                                                        @elseif($type_subpage == 'products')
                                                            <a class="dropdown-item select-prot-search cursor-p " data-protocol="subject" data-prew="название товара">название товара</a>
                                                        @elseif($type_subpage == 'other')
                                                ...
                                                ?>
                                                <form class="form-control" action="{{ asset('company/messages/') }}" method="get" id="search-form">
                                ...
                                @include('provider.company.message.index.layouts.thead', ['type' => $type_subpage])

                                <tbody id="charts-place">

                                    @include('provider.company.message.index.layouts.chart', ['type' => $type_subpage, 'charts' => $charts])
...
<script>
    ...
    $('.container-fluid').on('click', '.select-prot-search', function (e) {
        ...
        // var typeSearch = $('#search-protocol').val();
        // console.log(typeSearch);
        // if(typeSearch == 'created_at'){
        //     inpSearchText.addClass('mask-date');
        //     $(".mask-date").mask("9999-99-99", { placeholder: "" });
        // }else{
        //     inpSearchText.removeClass('mask-date');
        //     $(".mask-date").unmask();
        // }
    });
