    ...
    <div class="content-wrapper">
        <div class="container-fluid">
            ...
            <div class="subtab d-flex flex-column flex-sm-row justify-content-between align-items-center font-weight-bold text-uppercase blue-d-t p-2">
                ...
                <!-- <label class="mr-md-5 view-select">
                    <select class="blue-d-t pr-3 font-weight-bold text-uppercase">
                        <option selected>Просмотреть</option>
                        <option>10</option>
                        <option>100</option>
                    </select>
                </label> -->
                ...
                <tr class="tb-head text-uppercase blue-d-t text-center">
                    ...
                    <th scope="col" class="h-60">
                        <div class="d-block p-3 h-100 border-top border-bottom border-blue dark-link">
                            ...
                            <div class="dropdown">
                                <button class="btn-trans dropdown-toggle d-flex align-items-center font-weight-bold text-uppercase mx-auto" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
