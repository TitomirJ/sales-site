    ...
    <div class="dropdown-menu border-radius border-0 text-lowercase shadow-custom">
        @if($p->status_moderation == '2')
            ...
            @if($p->deleted_at == null)
                <a class="check-edit-product dropdown-item font-weight-bold drop-menu-actions" data-check="{{ asset('company/check/edit/product/'.$p->id) }}" myUrl="{{ asset('company/products/'.$p->id.'/edit') }}">Редактировать</a>
