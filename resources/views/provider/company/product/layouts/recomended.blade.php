...
@endforelse
<tr>
    <td scope="col" colspan="9" class="text-center container-fluid all-products-pagination" all-product-current-page="{{ $products_nomoder->currentPage() }}" type="2">{{ $products_nomoder->links() }}</td>
</tr>
