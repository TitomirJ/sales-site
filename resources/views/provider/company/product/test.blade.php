                                ...
                                <div class="row mt-4 price-block">
                                    ...
                                    <div class="col-12 col-md-8 d-flex flex-column justify-content-center p-3 border border-blue b-t-r b-b-r font-weight-bold">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" step="any" min="0" class="form-control check-price form-price" id="product-price" name="price" placeholder="Укажите цену...">
                                        </div>
                                        <div class="form-group">
                                            <label for="old-price">Старая цена</label>
                                            <input type="number" step="any" min="0" class="form-control check-price" id="old-price" name="old_price" placeholder="Укажите старую цену...">
                                        </div>
                                        <div>
                                            <span id="komission">
