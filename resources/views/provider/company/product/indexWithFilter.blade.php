            ...
            <div class="d-flex flex-column flex-sm-row justify-content-between align-items-center f30 mt-5 mb-5">
                ...
                <div class="d-flex align-items-center instruction">
                    <div class="dark-bg border-radius shadow-custom text-white pl-4 pr-4 pt-1 pb-1 mr-2 f13">
                        инструкция по <a href="{{asset('pdf/2.Create product.pdf')}}" target="_blank">Созданию товара</a>, <a href="{{asset('pdf/3.Create product_YML.pdf')}}" target="_blank">Добавление по YML</a>, <a href="{{asset('pdf/4.Work with product.pdf')}}" target="_blank">Работе с товарами</a>
                    </div>
                </div>
            </div>
                                    ...
                                    <tr class="tb-head text-uppercase blue-d-t text-center">
                                        <th colspan="9" scope="col">
                                            <div class="d-flex p-2 radius-top-left border-left border-top border-bottom border-blue text-nowrap dark-link">
                                                ...
                                                <a href="{{ asset('company/update/products') }}" class="btn square_btn btn-light bg-white shadow-custom text-uppercase border-radius-50 ml-2 mr-2">Обновить</a>
...
@section('script2')
    ...
    <script src="{{ asset('js/pages/provider/product/index_p.js?v='.$random_num) }}"></script>
@endsection