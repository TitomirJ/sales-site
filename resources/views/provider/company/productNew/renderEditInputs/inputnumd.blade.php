<div class="row option-item" data-option-item="{{$parametr->id}}">
    <div class="col-12">
        <div class="form-group">
            ...
            <input type="number" id="numd-input-{{$parametr->id}}" class="form-control check-render-input" min="0" step="any" name="default_parametr[parametr][{{ $parametr->attr_type }}][{{$parametr->id}}]" value="{{ $p_value }}">
        </div>
    </div>
</div>