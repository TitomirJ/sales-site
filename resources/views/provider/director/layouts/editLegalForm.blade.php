...
@if($company->type_company == '0')
    ...
    <div class="form-group">
        ...
        <input type="text" class="legal-input2 form-control" name="legal_data[]" form="update-company-form" value="{{ $company_data[0] }}" autofocus>
    </div>
    <div class="form-group">
        <label for="name">Юридический адрес </label>
        <input type="text" class="legal-input2 form-control" name="legal_data[]" form="update-company-form" value="{{ $company_data[1] }}" autofocus>
    </div>
...
@elseif($company->type_company == '1')
    ...
    <div class="form-group">
        ...
        <input type="text" class="legal-input2 form-control" name="legal_data[]" form="update-company-form" value="{{ $company_data[2] }}" autofocus>
    </div>
    <div class="form-group">
        <label for="name">Индивидуальный налоговый номер (ИНН) </label>
        <input type="text" class="legal-input2 form-control" name="legal_data[]" form="update-company-form" value="{{ $company_data[3] }}" autofocus>
    </div>
