    ...
    public function cnb_form($params)
    {
        ...
        return sprintf('
            <form method="POST" action="%s" accept-charset="utf-8">
                %s
                %s
                <button class="text-uppercase shadow-custom text-white font-weight-bold bg-success border-radius-50 border-0 pt-2 pb-2 pl-3 pr-3" name="btn_text" >оплатить</button>
            </form>
            ',
            $this->_checkout_url,
